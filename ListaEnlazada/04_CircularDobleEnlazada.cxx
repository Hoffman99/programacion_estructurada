...
class Listadoble{
    ...
    public:
        ...
        void mostraranilloinverso(Listadoble& lista){
            int cantidad;
            Nodo* actual = lista.cola;
            cout<<"Ingrese el numero de nodos que quiere que aparezcan ==> ";
            cin>>cantidad;
...
void menuLista(Listadoble& lista_, Listadoble& sub){
    int resp=0, opcion=0;
    while(resp==0){
        cout<<"Mostrar de principio a fin (1)"<<endl;
        cout<<"Mostrar de fin al principio (2)"<<endl;
        cout<<"Mostrar N veces de principio a fin (3)"<<endl;
        cout<<"Mostrar N veces de fin a principio (4)"<<endl;
        ...
        switch(opcion){
            ...
            if(0<sub.tamanio()){
                cout << "Elementos de la lista: "<<endl;
                lista_.mostraranilloinverso(lista_);
                cout << "Elementos de la sublista: "<<endl;
                sub.mostraranilloinverso(sub);
             }else{
                cout << "Elementos de la lista: "<<endl;
                lista_.mostraranilloinverso(lista_);
            }
